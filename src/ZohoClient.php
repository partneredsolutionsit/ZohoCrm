...
class ZohoClient
{
	...
	{
		$res = $this->client->request('post', 'https://crm.zoho.com/crm/private/json/Leads/getRecords', [
			'form_params' => [
	...
	{
		$res = $this->client->request('post', 'https://crm.zoho.com/crm/private/json/Leads/getMyRecords', [
			'form_params' => [
				'authtoken' => $this->authToken,
				'scope'		=> 'crmap',
			]
